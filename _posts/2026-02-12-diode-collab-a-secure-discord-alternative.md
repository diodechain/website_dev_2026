...
Diode Collab is built on Zero Trust and decentralized principles, ensuring that _only_ users ever hold the encryption keys. Diode itself never sees any information or data from its users. This means:

**Full Data Custody:** Users retain total control, storing messages and files only on their own devices.

**Secure Community Zones:** Like Discord servers—but fully private and encrypted—Zones let you create secure spaces for your communities or teams, where messages, files, and access stay entirely within your control.

**End-to-End Encryption for Secure Chat and File Sharing:** Every conversation, file transfer, or collaboration is protected by true end-to-end encryption, ensuring no third party can intercept or read your data.

**Private by Design:** You don’t need to provide any personal information to use it—no phone number, no email, no identity requirement.

**Offline Functionality:** Diode Collab operates even without a stable internet connection, keeping productivity uninterrupted.

**Censorship Resistance:** Because it’s decentralized, communication cannot be censored or monitored.
